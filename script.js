...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Halo mas krisnaaaa", "Aku punya pertanyaan niiii", "question").then(function () {
      ...
      Swal.fire("Awasss yaaa kalooo boong samean wkwk", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            ...
            denyButtonText: `Nggak sama sekali HAHA`,
          }).then((result) => {
            /* Read more about isConfirmed, isDenied below */
            if (result.isConfirmed) {
              Swal.fire(`${sender} kangen juga gak ya sama mas ${nama} wkwkw`).then(function () {
                Swal.fire({
                  title: 'Seberapa kangen emangnya mas ke akkk XIXI? GA KANGEN PIS',
                  icon: 'question',
                  input: 'range',
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya mas buat...buat udah gelem tak repotin selama kenal kee ${sender} WKWK`).then(function () {
                    Swal.fire({
